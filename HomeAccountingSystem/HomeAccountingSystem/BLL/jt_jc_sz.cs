...
namespace HomeAccountingSystem.BLL
{
	...
	{
		private readonly HomeAccountingSystem.DAL.jt_jc_sz dal=new HomeAccountingSystem.DAL.jt_jc_sz();
		public jt_jc_sz()
		{}
		#region  BasicMethod
		...
		/// 获得数据列表
		/// </summary>
		public List<HomeAccountingSystem.Model.jt_jc_sz> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<HomeAccountingSystem.Model.jt_jc_sz> DataTableToList(DataTable dt)
		{
			List<HomeAccountingSystem.Model.jt_jc_sz> modelList = new List<HomeAccountingSystem.Model.jt_jc_sz>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				HomeAccountingSystem.Model.jt_jc_sz model;
