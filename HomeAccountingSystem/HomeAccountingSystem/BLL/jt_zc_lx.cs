...
namespace HomeAccountingSystem.BLL
{
	...
	public partial class jt_zc_lx
	{
		...
		/// 获得数据列表
		/// </summary>
		public List<HomeAccountingSystem.Model.jt_zc_lx> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<HomeAccountingSystem.Model.jt_zc_lx> DataTableToList(DataTable dt)
		{
			List<HomeAccountingSystem.Model.jt_zc_lx> modelList = new List<HomeAccountingSystem.Model.jt_zc_lx>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				HomeAccountingSystem.Model.jt_zc_lx model;
