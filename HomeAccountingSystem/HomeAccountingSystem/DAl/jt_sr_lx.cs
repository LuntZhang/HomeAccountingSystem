...
namespace HomeAccountingSystem.DAL
{
	...
	public partial class jt_sr_lx
	{
		...
		public int GetMaxId()
		{
		return SQLServerHelper.GetMaxID("pk", "jt_sr_lx"); 
		}
		...
		public bool Exists(int pk)
		{
			...
			strSql.Append("select count(1) from jt_sr_lx");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into jt_sr_lx(");
			strSql.Append("v_sr_no,v_srlx_name,t_create_time,i_delete)");
			strSql.Append(" values (");
			strSql.Append("@v_sr_no,@v_srlx_name,@t_create_time,@i_delete)");
			SqlParameter[] parameters = {
					new SqlParameter("@pk", SqlDbType.Int,4),
					new SqlParameter("@v_sr_no", SqlDbType.VarChar,4000),
					new SqlParameter("@v_srlx_name", SqlDbType.VarChar,4000),
					new SqlParameter("@t_create_time", SqlDbType.DateTime),
					new SqlParameter("@i_delete", SqlDbType.Int,4)};
			parameters[0].Value = model.pk;
			parameters[1].Value = model.v_sr_no;
			parameters[2].Value = model.v_srlx_name;
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update jt_sr_lx set ");
			strSql.Append("v_sr_no=@v_sr_no,");
			...
			SqlParameter[] parameters = {
					...
					new SqlParameter("@i_delete", SqlDbType.Int,4),
					new SqlParameter("@pk", SqlDbType.Int,4)};
			parameters[0].Value = model.v_sr_no;
			parameters[1].Value = model.v_srlx_name;
		...
		public bool Delete(int pk)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from jt_sr_lx ");
			strSql.Append(" where pk=@pk ");
			SqlParameter[] parameters = {
					new SqlParameter("@pk", SqlDbType.Int,4)			};
			parameters[0].Value = pk;
		...
		public HomeAccountingSystem.Model.jt_sr_lx GetModel(int pk)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 pk,v_sr_no,v_srlx_name,t_create_time,i_delete from jt_sr_lx ");
			strSql.Append(" where pk=@pk ");
			SqlParameter[] parameters = {
					new SqlParameter("@pk", SqlDbType.Int,4)			};
			parameters[0].Value = pk;

			HomeAccountingSystem.Model.jt_sr_lx model=new HomeAccountingSystem.Model.jt_sr_lx();
		...
		/// 得到一个对象实体
		/// </summary>
		public HomeAccountingSystem.Model.jt_sr_lx DataRowToModel(DataRow row)
		{
			HomeAccountingSystem.Model.jt_sr_lx model=new HomeAccountingSystem.Model.jt_sr_lx();
			if (row != null)
			{
				...
				if(row["v_sr_no"]!=null)
				{
					model.v_sr_no=row["v_sr_no"].ToString();
				}
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select pk,v_sr_no,v_srlx_name,t_create_time,i_delete ");
			strSql.Append(" FROM jt_sr_lx ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetList(int Top,string strWhere,string filedOrder)
		{
			...
			strSql.Append(" pk,v_sr_no,v_srlx_name,t_create_time,i_delete ");
			strSql.Append(" FROM jt_sr_lx ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from jt_sr_lx T ");
