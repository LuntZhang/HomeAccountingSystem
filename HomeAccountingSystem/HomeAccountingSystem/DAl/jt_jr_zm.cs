...
namespace HomeAccountingSystem.DAL
{
	...
	public partial class jt_jr_zm
	{
		...
		public int GetMaxId()
		{
		return SQLServerHelper.GetMaxID("pk", "jt_jr_zm"); 
		}
		...
		public bool Exists(int pk)
		{
			...
			strSql.Append("select count(1) from jt_jr_zm");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into jt_jr_zm(");
			strSql.Append("v_jrzm_no,v_jrzm_name,t_jr_time,v_jr_who,f_jr_money,f_accrual,v_jr_name,t_gh_time,i_gh_flag,f_gh_how_money,v_remark,v_jz_user_pk,v_jz_user_name,t_create_time,i_delete)");
			strSql.Append(" values (");
			strSql.Append("@v_jrzm_no,@v_jrzm_name,@t_jr_time,@v_jr_who,@f_jr_money,@f_accrual,@v_jr_name,@t_gh_time,@i_gh_flag,@f_gh_how_money,@v_remark,@v_jz_user_pk,@v_jz_user_name,@t_create_time,@i_delete)");
			SqlParameter[] parameters = {
					new SqlParameter("@pk", SqlDbType.Int,4),
					new SqlParameter("@v_jrzm_no", SqlDbType.VarChar,256),
					new SqlParameter("@v_jrzm_name", SqlDbType.VarChar,256),
					new SqlParameter("@t_jr_time", SqlDbType.DateTime),
					new SqlParameter("@v_jr_who", SqlDbType.VarChar,256),
					new SqlParameter("@f_jr_money", SqlDbType.Float,8),
					new SqlParameter("@f_accrual", SqlDbType.Float,8),
					new SqlParameter("@v_jr_name", SqlDbType.VarChar,256),
			...
			parameters[1].Value = model.v_jrzm_no;
			parameters[2].Value = model.v_jrzm_name;
			parameters[3].Value = model.t_jr_time;
			parameters[4].Value = model.v_jr_who;
			parameters[5].Value = model.f_jr_money;
			parameters[6].Value = model.f_accrual;
			parameters[7].Value = model.v_jr_name;
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update jt_jr_zm set ");
			strSql.Append("v_jrzm_no=@v_jrzm_no,");
			strSql.Append("v_jrzm_name=@v_jrzm_name,");
			strSql.Append("t_jr_time=@t_jr_time,");
			strSql.Append("v_jr_who=@v_jr_who,");
			strSql.Append("f_jr_money=@f_jr_money,");
			strSql.Append("f_accrual=@f_accrual,");
			strSql.Append("v_jr_name=@v_jr_name,");
			...
			SqlParameter[] parameters = {
					...
					new SqlParameter("@i_delete", SqlDbType.Int,4),
					new SqlParameter("@pk", SqlDbType.Int,4)};
			parameters[0].Value = model.v_jrzm_no;
			parameters[1].Value = model.v_jrzm_name;
			parameters[2].Value = model.t_jr_time;
			parameters[3].Value = model.v_jr_who;
			parameters[4].Value = model.f_jr_money;
			parameters[5].Value = model.f_accrual;
			parameters[6].Value = model.v_jr_name;
		...
		public bool Delete(int pk)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from jt_jr_zm ");
			strSql.Append(" where pk=@pk ");
			SqlParameter[] parameters = {
					new SqlParameter("@pk", SqlDbType.Int,4)			};
			parameters[0].Value = pk;
		...
		public HomeAccountingSystem.Model.jt_jr_zm GetModel(int pk)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 pk,v_jrzm_no,v_jrzm_name,t_jr_time,v_jr_who,f_jr_money,f_accrual,v_jr_name,t_gh_time,i_gh_flag,f_gh_how_money,v_remark,v_jz_user_pk,v_jz_user_name,t_create_time,i_delete from jt_jr_zm ");
			strSql.Append(" where pk=@pk ");
			SqlParameter[] parameters = {
					new SqlParameter("@pk", SqlDbType.Int,4)			};
			parameters[0].Value = pk;

			HomeAccountingSystem.Model.jt_jr_zm model=new HomeAccountingSystem.Model.jt_jr_zm();
		...
		/// 得到一个对象实体
		/// </summary>
		public HomeAccountingSystem.Model.jt_jr_zm DataRowToModel(DataRow row)
		{
			HomeAccountingSystem.Model.jt_jr_zm model=new HomeAccountingSystem.Model.jt_jr_zm();
			if (row != null)
			{
				...
				if(row["v_jrzm_no"]!=null)
				{
					model.v_jrzm_no=row["v_jrzm_no"].ToString();
				}
				if(row["v_jrzm_name"]!=null)
				{
					model.v_jrzm_name=row["v_jrzm_name"].ToString();
				}
				if(row["t_jr_time"]!=null && row["t_jr_time"].ToString()!="")
				{
					model.t_jr_time=DateTime.Parse(row["t_jr_time"].ToString());
				}
				if(row["v_jr_who"]!=null)
				{
					model.v_jr_who=row["v_jr_who"].ToString();
				}
				if(row["f_jr_money"]!=null && row["f_jr_money"].ToString()!="")
				{
					model.f_jr_money=decimal.Parse(row["f_jr_money"].ToString());
				}
				if(row["f_accrual"]!=null && row["f_accrual"].ToString()!="")
				{
					model.f_accrual=decimal.Parse(row["f_accrual"].ToString());
				}
				if(row["v_jr_name"]!=null)
				{
					model.v_jr_name=row["v_jr_name"].ToString();
				}
		...
		public DataSet GetList(int Top,string strWhere,string filedOrder)
		{
			...
			strSql.Append(" pk,v_jrzm_no,v_jrzm_name,t_jr_time,v_jr_who,f_jr_money,f_accrual,v_jr_name,t_gh_time,i_gh_flag,f_gh_how_money,v_remark,v_jz_user_pk,v_jz_user_name,t_create_time,i_delete ");
			strSql.Append(" FROM jt_jr_zm ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from jt_jr_zm T ");
